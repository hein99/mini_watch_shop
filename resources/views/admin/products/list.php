    ...
    <?php foreach($data['categories'] as $category) : ?>
        ...
        <div>
            ...
            <div>
                ...
                <p><span><?php echo number_format($product->getValueEncoded('price')) ?></span>
                <span><?php echo $product->getFinalPrice() ?> MMK</span> <span><?php echo $product->getValueEncoded('discount_percentage') ?> %</span></p>
